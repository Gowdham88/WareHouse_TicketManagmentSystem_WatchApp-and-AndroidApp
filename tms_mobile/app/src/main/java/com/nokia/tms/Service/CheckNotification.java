...
import com.nokia.tms.Utils.Restarter;
    ...
    void checkNotification() {
        StringRequest request = new StringRequest(Request.Method.GET, AppUrls.NOTIFICATION_CHECK, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    JSONObject object=new JSONObject(response).getJSONObject("fields").getJSONObject("val");
                    String s=object.getString("stringValue");
